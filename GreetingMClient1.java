...
public class GreetingMClient1 extends Thread {
		...
		Socket client;
		String username,password,randonnum;
   public GreetingMClient1(Socket client,String username,String password,String randonnum){
	   this.client=client;
	   this.username=username;
	   this.password=password;
	   this.randonnum=randonnum;
   }
   public GreetingMClient1(){
   ...
   public void run(){
	   try {
		 ...
		 String temp;
		 GreetingMClient1 greetingClient=new GreetingMClient1();
   ...
   public static void main(String [] args) {	  
	  ...
	  String [] usernames={"hello","sachin","shabab","utkarsh","you","abcd","kjvwje","wciwue","hello","sachin","utkarsh","you","abcd","kjvwje","wciwue","hello","sachin","utkarsh","you","abcd","kjvwje","wciwue","hello","123456","123456","123456","you","abcd","whviweu","wivbiuwe","hello","123456","123456"};
	  String [] passwords={"hello","123456","123456","123456","you","abcd","whviweu","wivbiuwe","hello","123456","123456","123456","you","abcd","whviweu","wivbiuwe","hello","123456","123456","123456","you","abcd","whviweu","wivbiuwe","hello","123456","123456","123456","you","abcd","whviweu","wivbiuwe"};
	  String [] randomnumbers={"46467","74898","48495","74848","67895","57686","51666","31156","32151","35486","35488"};
	  try{
	  for(i=0;i<number;i++){
		  int index=random.nextInt(6);
		  String username=usernames[index];
		  String password=passwords[index];
		  String randonnum=randomnumbers[index];
		  Socket client = new Socket(serverName, port);
		  Thread t = new GreetingMClient1(client,username,password,randonnum);
          t.start();
	  }
	  }
	  catch(Exception e){
